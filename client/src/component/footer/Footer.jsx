    ...
    <>
      <div className='flex justify-start xl:gap-10 lg:gap-10 md:gap-6 sm:gap-0 gap-0 items-start bg-gray-100  h-fit py-5 flex-wrap px-4 '>
        ...
        <div className='w-[350px] font-serif mt-10'>
          ...
          <div>
            <div className='text-gray-800 cursor-pointer my-2 flex items-start' ><span className='mr-2 text-lg mt-1'><IoLocationOutline /></span> GL EXPORTS, A-46, Sector-64, NOIDA-Up, Pin-201301.</div>
