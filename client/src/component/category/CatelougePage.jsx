                ...
                <div className='w-full mb-10'>
                    {categories.map((category) => (
                        <div key={category._id} className='text-center text-black '>
                            <h1 className='uppercase xl:text-[2rem] text-red-900 mt-20'>
                                ...
                                <div className='w-[95%] h-90 flex flex-wrap xl:justify-start md:justify-center sm:justify-center justify-center gap-6 mt-4'>
                                    {
                                        ...
                                        subCategories.filter(item => item.parentCategory._id === category._id).map(subCat => (
                                            <div
                                                key={subCat._id}
                                                className='cursor-pointer w-72 h-88 border cursor-pointerpx-4 py-2 flex flex-col justify-center items-center rounded-lg hover:shadow-md hover:shadow-gray-700 hover:border-none  transition'
                                            ...
                                            >
                                                ...
                                                <div className='text-[1.5rem] capitalize text-gray-800'> {subCat.name}</div>
                                            </div>
                                        ))
                                    }
                                </div>
